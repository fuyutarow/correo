...
//   外部較正の収束（2026-07-17 採録・coji/natural-japanese の antithesis 再較正・独立 corpus）:
//   「ではなく」級の対比率は人間中央値 1.5/100文 vs AI 中央値 8.3/100文 — 閾値 4.0 はその間に
//   座り、同 project も比率 3.0 以上を critical とした。別 corpus・別実装で同じ向き・同じ桁。
//
